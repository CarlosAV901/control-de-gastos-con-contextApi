...
export default function ExpenseFrom() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        //validar para no pasar el limite
    ...
    return (
        <form className="space-y-5" onSubmit={handleSubmit}>
            <legend className="uppercase text-center text-2xl font-black  border-b-4 py-2 border-blue-500">{state.editingId ? 'Editar Gasto' : 'Nuevo Gasto'}</legend>
